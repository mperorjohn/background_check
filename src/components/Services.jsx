  ...
  return (
      <div className='items-center justify-center flex flex-col p-10'>
          ...
          <div className='grid grid-cols-3 gap-4' >
              <Card image="/src/assets/react.svg" alt="Credit Card" heading="CREDIT CARD" details="compare and choose offers from top providers to find the credit card that suits your needs" />  
              <Card image="/src/assets/react.svg" alt="Credit Card" heading="CREDIT CARD" details="compare and choose offers from top providers to find the credit card that suits your needs" />  
              <Card image="/src/assets/react.svg" alt="Credit Card" heading="CREDIT CARD" details="compare and choose offers from top providers to find the credit card that suits your needs" />  
              <Card image="/src/assets/react.svg" alt="Credit Card" heading="CREDIT CARD" details="compare and choose offers from top providers to find the credit card that suits your needs" />  
              <Card image="/src/assets/react.svg" alt="Credit Card" heading="CREDIT CARD" details="compare and choose offers from top providers to find the credit card that suits your needs" />  
